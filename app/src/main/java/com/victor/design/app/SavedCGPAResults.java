...
public class SavedCGPAResults extends ActionBarActivity {

    private LinearLayout gpaLayout, cgpaLayout;
    ...
    public void onCreate(Bundle bundle) {
        ...
        cgpaLayout = (LinearLayout) findViewById(R.id.llCGPAContainer);
        gpaLayout = (LinearLayout) findViewById(R.id.llGPAContainer);
        gpaLayout.setVisibility(LinearLayout.GONE);
        cgpaLayout.setVisibility(LinearLayout.VISIBLE);
